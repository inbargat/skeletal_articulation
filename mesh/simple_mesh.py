...
class SimpleMesh:
    ...
    def prepare_mesh(self):
        ...
        self.v_mask = np.ones((self.vs.shape[0], ), dtype=bool)
        self.f_mask = np.ones((self.faces.shape[0], ), dtype=bool)
        self.e_mask = np.ones((self.edges.shape[0], ), dtype=bool)
    ...
    def clear(self):
        ...
        new_idx = np.zeros(self.v_mask.shape[0], dtype=int)
